...
const createPlaylist = asyncHandler(async (req, res) => {
    ...
    if(!name || !description){
        throw new ErrorApi(400,"name & description required")
    }
    ...
    if(!playlist){
        throw new ErrorApi(500,"playlist is not created..failed!!")
    }
    return res.status(200).json(new ResponseApi (200,playlist,"playlist created suucessfuly"))
